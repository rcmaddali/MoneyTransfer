...
public class Xoom extends BasePage{
	...
	public void chooseCountry() {
		...
		//Select chooseCountryfromDrpDwn = new Select(driver.findElement(By.xpath("")));
	...
	public void getRate() {
		...
		String rate = driver.findElement(By.xpath("//*[@id=\"js-ui-content-update-animation-item-0\"]/p/text()")).toString();
