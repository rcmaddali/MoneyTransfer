...
/*	@BeforeMethod
	public static void browser() {
		...
		Assert.assertEquals(strPageTitle.equalsIgnoreCase("Google"), "Page title does not match");
	...
	driver.switchTo().window(arr.get(1));
		...
		trate = driver.findElement(By.className("exchange-rate")).getText();
		 driver.findElement(By.xpath("/html/body/div[2]/div/div/div[1]/div/div/div[2]/div/div/div[1]/div[1]/div[3]/span[4]")).getAttribute("exchange-rate");
	...
	driver.switchTo().window(arr.get(1));
		...
		rrate = driver
				.findElement(By.xpath("/html/body/div[3]/div[1]/div/div/div[1]/div/div[3]/div[2]/div[3]/div[2]/p[1]"))
				.getText();
